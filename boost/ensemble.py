...
if __name__ == "__main__":
    ...
    arg('--RESULT_PATH',type=str, default="/opt/ml/level2_dkt_recsys-level2-recsys-11/boost/output/",
        help='optional: 앙상블할 파일이 존재하는 경로를 전달합니다. (default:"/opt/ml/level2_dkt_recsys-level2-recsys-11/boost/output")')
