...
def parse_args():
    ...
    parser.add_argument("--grow_policy", default='Lossguide', type=str, help="tree grow policy")
    ...
    parser.add_argument("--has_time", default=False, type=bool, help="whether has_time parameter is used")
