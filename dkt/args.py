...
def parse_args():
    ...
    parser.add_argument("--max_seq_len", default=32, type=int, help="max sequence length" )
    ...
    parser.add_argument("--cont_proj_dim", default=1, type=int) # 수치형 피처 수보다 적어야 좋을듯. 아니야 riid 는 더 크게 해.
    parser.add_argument(
